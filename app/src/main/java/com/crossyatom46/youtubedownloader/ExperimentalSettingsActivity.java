...
public class ExperimentalSettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = ExperimentalSettingsActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_command_experimental);
    ...
    private void runCommand() {
        if (running) {
            Toast.makeText(ExperimentalSettingsActivity.this, "cannot start command. a command is already in progress", Toast.LENGTH_LONG).show();
            return;
        }

        if (!isStoragePermissionGranted()) {
            Toast.makeText(ExperimentalSettingsActivity.this, "grant storage permission and retry", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        Disposable disposable =
                ...
                .subscribe(youtubeDLResponse -> {
                    ...
                    Toast.makeText(ExperimentalSettingsActivity.this, "command successful", Toast.LENGTH_LONG).show();
                    running = false;
                }, e -> {
                    ...
                    Toast.makeText(ExperimentalSettingsActivity.this, "command failed", Toast.LENGTH_LONG).show();
                    running = false;
                });
