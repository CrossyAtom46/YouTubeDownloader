...
public class MP4DownloadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String processId = "MyDlProcess2";
    ...
    private static final String TAG = MP4DownloadActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mp4_downloading);
    ...
    private void initViews() {
        btnStartDownload = findViewById(R.id.btn_start_download2);
        btnStopDownload = findViewById(R.id.btn_stop_download2);
        etUrl = findViewById(R.id.et_url2);
        progressBar = findViewById(R.id.progress_bar2);
        tvDownloadStatus = findViewById(R.id.tv_status2);
        pbLoading = findViewById(R.id.pb_status2);
        tvCommandOutput = findViewById(R.id.tv_command_output2);
    }
    ...
    private void startDownload() {
        if (downloading) {
            Toast.makeText(MP4DownloadActivity.this, (getString(R.string.start_error)), Toast.LENGTH_LONG).show();
            return;
        }

        if (!isStoragePermissionGranted()) {
            Toast.makeText(MP4DownloadActivity.this, (getString(R.string.storage_permission)), Toast.LENGTH_LONG).show();
            return;
        }
        ...
        Disposable disposable = Observable.fromCallable(() -> YoutubeDL.getInstance().execute(request, processId, callback))
                ...
                .subscribe(youtubeDLResponse -> {
                    ...
                    Toast.makeText(MP4DownloadActivity.this, (getString(R.string.download_complete)), Toast.LENGTH_LONG).show();
                    downloading = false;
                }, e -> {
                    ...
                    Toast.makeText(MP4DownloadActivity.this, (getString(R.string.download_failed)), Toast.LENGTH_LONG).show();
                    downloading = false;
                });
    ...
    private File getDownloadLocation() {
        ...
        File youtubeDLDir = new File(downloadsDir, "YT-MP4");
